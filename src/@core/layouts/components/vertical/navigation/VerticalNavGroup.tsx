    ...
    <Fragment>
      <ListItem
        ...
        sx={{
          ...
          px:
            parent && item.children ? '0 !important' : `${theme.spacing(navCollapsed && !navHover ? 2 : 3)} !important`
        }}
      >
        <ListItemButton
          className={groupActive.includes(item.title) || currentActiveGroup.includes(item.title) ? 'Mui-selected' : ''}
          sx={{
            py: 2.25,
            width: '100%',
            borderRadius: '8px',
